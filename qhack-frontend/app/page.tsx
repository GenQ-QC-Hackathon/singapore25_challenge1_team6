    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="min-h-screen flex items-center justify-center px-6">
        <div className="container mx-auto text-center max-w-7xl">
          ...
          >
            <Link href="/dashboard">
              <button className="group px-8 py-4 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold text-lg flex items-center gap-3 min-w-[200px] justify-center transition-colors duration-200">
            ...
            <Link href="/about">
              <button className="group px-8 py-4 rounded-lg border-2 border-slate-300 hover:border-violet-500 bg-white hover:bg-violet-50 text-slate-700 hover:text-violet-700 font-semibold text-lg flex items-center gap-3 min-w-[200px] justify-center transition-all duration-200">
          ...
          >
            {/* Feature 1 */}
            <div className="bg-white shadow-sm hover:shadow-md rounded-xl p-6 transition-shadow duration-200 hover:-translate-y-1 transition-transform">
